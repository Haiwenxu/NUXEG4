...
//
//
/// \file NUXE/src/LXeEventMessenger.cc
  ...
  : fLXeEvent(event)
{
  ...
  fSipmThresholdCmd = new G4UIcmdWithAnInteger("/LXe/SipmThreshold", this);
...
void LXeEventMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
  ...
  {
    fLXeEvent->SetSiPMThreshold(fSipmThresholdCmd->GetNewIntValue(newValue));
  }
